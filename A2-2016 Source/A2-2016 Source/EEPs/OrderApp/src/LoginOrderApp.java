 ...
 * @author Tang
 */
public class LoginOrderApp extends javax.swing.JFrame implements ActionListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginOrderApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
