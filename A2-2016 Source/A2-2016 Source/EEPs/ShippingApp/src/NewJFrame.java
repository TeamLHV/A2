...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (!orderBlank) {
            try {
                orderInfo = orderService.getOrderByID(Long.valueOf(orderID));
                ...
                jTextField2.setText(orderInfo.getFirstName()); // first name
                jTextField3.setText(orderInfo.getLastName()); // last name
                jTextField4.setText(orderInfo.getPhone()); // phone
                jTextField5.setText(orderInfo.getOrderDate()); // order date
                jTextArea2.setText(orderInfo.getAddress());  // address

                // get the order items from the related order table
                items = orderService.getAllItems(orderInfo);

                // list the items on the form that comprise the order
                jTextArea3.setText("");

                for (OrderItemInfo item : items) {
                    msgString = item.getItemID() + ":  PRODUCT ID: " + item.getProductCode()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            orderService.shipOrder(orderService.getOrderByID((long) updateOrderID));
    ...
    private void getPendingOrders() {
        ...
        try {
            ...
            for (OrderInfo order : orders) {
                ...
                if (!order.getShipped()) {
                    msgString = "ORDER # " + order.getOrderID() + " : " + order.getOrderDate()
    ...
    private void getShippedOrders() {
        ...
        try {
            ...
            for (OrderInfo order : orders) {
                ...
                if (order.getShipped()) {
                    msgString = "SHIPPED ORDER # " + order.getOrderID() + " : " + order.getOrderDate()
                            + " : " + order.getFirstName() + " : " + order.getLastName();
                    jTextArea1.append(msgString + "\n");
