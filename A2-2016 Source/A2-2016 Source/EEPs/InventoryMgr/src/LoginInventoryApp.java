 ...
 * @author Tang
 */
public class LoginInventoryApp extends javax.swing.JFrame implements ActionListener {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        dispose();
        new InventoryMainFrame(ui).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginInventoryApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
